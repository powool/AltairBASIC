...
PUTNEW:
	...
	IF	LENGTH=2
; Read 3-byte string descriptor from (HL)
; Returns [D]=LENGTH [B,C]=POINTER AT DATA
; Advances HL past the descriptor
GETBCD:
	MOV	D,M		;GET LENGTH
	INX	H
	MOV	C,M		;GET POINTER LO
	INX	H
	MOV	B,M		;GET POINTER HI
	INX	H
	RET
	ENDIF
...
UNPACK:
	...
	PUSH	PSW		;SAVE SIGN
	ORI	128		;RESTORE THE HIDDEN ONE
	MOV	M,A		;SAVE HO
	POP	PSW		;GET SIGN
