...
LISTEN	EQU	0		;ON MEANS LISTEN FOR ^C
...
FUNCTS	EQU	0
	ENDIF
;        INTERNAL        .C1,BUF,READY,REASON,SNERR,OMERR,REPINI
...
;        INTERNAL        CNLCA1,CNLCA2,CNLCA3
	ENDIF
	IF	EXTFNC<>0
;        INTERNAL        ATNFIX,COSFIX,SINFIX,TANFIX
;        EXTERNAL        FPWR,EXP
	ENDIF
...
;        INTERNAL        ILLFUN,FAC,FACLO,TXTTAB,STROUT,SCRTCH
...
VALTYP:
	DS	1		;THE TYPE INDICATOR
                                ;IN THE 8K 0=NUMERIC 1=STRING
OPRTYP:			;USED TO STORE OPERATOR NUMBER
                                ;IN THE EXTENDED MOMENTARILY BEFORE
                                ;OPERATOR APPLICATION
DORES:
	DS	1		;WHETHER CAN OR CAN'T CRUNCH RES'D WORDS
                                ;TURNED ON IN THE 8K WHEN "DATA"
                                ;BEING SCANNED BY CRUNCH SO UNQUOTED
                                ;STRINGS WON'T BE CRUNCHED.
MEMSIZ:
	DS	2		;HIGHEST LOCATION IN MEMORY
TEMPPT:
	DS	2		;POINTER AT FIRST FREE TEMP DESCRIPTOR
                                ;INITIALIZED TO POINT TO TEMPST
TEMPST:
	DS	STRSIZ*NUMTMP		;STORAGE FOR NUMTMP DESCRIPTORS
DSCTMP:
	DS	STRSIZ		;STRING FUNCTIONS BUILD ANSWER DESCRIPTOR HERE
FRETOP:
	DS	2
	ENDIF
	IF	LENGTH!STRING<>0
...
DATLIN:
	DS	2		;DATA LINE # -- REMEMBER FOR ERRORS
SUBFLG:
	DS	1
	ENDIF
...
FLGINP:
	DS	1		;FLAGS WHETHER WE ARE DOING INPUT
                                ;OR A READ
TEMP:
	DS	2		;TEMPORARY FOR STATEMENT CODE
...
OLDLIN:
	DS	2		;OLD LINE NUMBER
OLDTXT:
	DS	2
	ENDIF
                                ;POINTS AT STATEMENT TO BE EXECUTED NEXT
STKTOP:
	DS	2		;TOP LOCATION TO USE FOR THE STACK
...
FAC:
	...
	DS	1		;[TEMPORARY LEAST SIGNIFICANT BYTE]
ARGLO:
	DS	7		;[LOCATION OF SECOND ARGUMENT FOR DOUBLE
ARG:
	DS	1
	ENDIF
FBUFFR:
...
;        SUBTTL  GENERAL STORAGE MANAGEMENT ROUTINES
        ...
        ;
FNDFOR:
	LXI	H,4+CODE		;IGNORING EVERYONES "NEWSTT"
...
LOOPER:
	...
	COMPAR
POPGOF:
	LXI	B,CODE+13		;TO WIPE OUT A FOR ENTRY
	POP	H
	...
	JMP	LOOPER		;TRY THE NEXT ONE
        ...
        ;
BLTU:
	CALL	REASON		;CHECK DESINTATION TO MAKE
                                ;SURE THE STACK WON'T BE OVERRUN
BLTUC:
	PUSH	B		;EXCHANGE [B,C] AND [H,L]
	XTHL
	POP	B
BLTLOP:
...
MLOOP:
	...
	ENDIF
NODEL:
	POP	D		;POP POINTER AT PLACE TO INSERT
...
ISGOSU:
	MOV	C,E		;GET COUNT INTO  [C]
LOOPON:
	DCR	C		;SEE IF ENOUGH SKIPS
...
;        SUBTTL  COMMON FILE
;        SALL
LENGTH	EQU	1		; 0 MEANS 4K, 1 MEANS 8K, 2 MEANS 12K
REALIO	EQU	1
